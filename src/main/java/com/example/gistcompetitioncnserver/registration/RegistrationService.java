...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request, HttpServletRequest urlRequest) {
        ...
        String link = baseUrl.substring(0, baseUrl.length() - 12) + "confirm?token=" + userService.signUpUser(
                user); // redirect home page in local
    ...
    public String resendEmail(User user, HttpServletRequest urlRequest) {
        ...
        Optional<EmailConfirmationToken> userEmailToken = emailConfirmationTokenService.findEmailTokenByUserId(
                user.getId());
        ...
        String baseUrl = urlRequest.getRequestURL().toString();
        String link =
                baseUrl.substring(0, baseUrl.length() - 12) + "confirm?token=" + token; // redirect home page in local
